...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 08 avr. 2019 à 14:08
...
(1, 'Company A', 'last Name A', 'first name A', NULL, 'Owner', '(123)555-0100', NULL, NULL, '(123)555-0101', '2158 address A', 'Chicago', 'WA', '99000', 'USA', NULL, NULL, ''),
...
(50, 'henry', '&lt;script&gt;alert(\'bravo\')&lt;/script&gt;', 'stephane', NULL, NULL, NULL, NULL, NULL, NULL, '&lt;script&gt;alert(\'bravo\')&lt;/script&gt;', 'paris', NULL, '75000', NULL, NULL, NULL, NULL);
...
--
-- Déchargement des données de la table `employee_privileges`
--
...
--
-- Déchargement des données de la table `inventory_transactions`
--
...
--
-- Déchargement des données de la table `inventory_transaction_types`
--
...
--
-- Déchargement des données de la table `orders_tax_status`
--
...
--
-- Déchargement des données de la table `order_details_status`
--
...
--
-- Déchargement des données de la table `purchase_order_details`
--
...
--
-- Déchargement des données de la table `purchase_order_status`
--
...
--
-- Déchargement des données de la table `sales_reports`
--
...
--
-- Déchargement des données de la table `strings`
--
